 ...
 */
public class Db2Object2DAO implements Object2DAO 
{
	// === Costanti letterali per non sbagliarsi a scrivere !!! ============================
	
	static final String TABLE = "table2"; //TODO
	...
	// INSERT INTO table2 ( id, string) VALUES ( ?,?);
	...
	// DELETE FROM table2 WHERE string = ?;
	...
	// UPDATE table2 SET string = ? WHERE id = ?;
	...
	// CREATE entrytable2 ( code INT NOT NULL PRIMARY KEY, ... );
	 ...
	 * C
	 */
	public void create(Object2DTO t) 
	{
		// --- 1. Dichiarazione della variabile per il risultato ---
	 ...
	 * R
	 */
	public Object2DTO read(int id) 
	{
		// --- 1. Dichiarazione della variabile per il risultato ---
		Object2DTO result = null;
		// --- 2. Controlli preliminari sui dati in ingresso ---
		if ( id < 0 )  
		{
		...
		try 
		{
			...
			// --- d. Cicla sul risultato (se presente) pe accedere ai valori di ogni sua tupla
			if ( rs.next() ) {
				Object2DTO entry = new Object2DTO();
	 ...
	 * U
	 */
	public boolean update(Object2DTO t) 
	{
		// --- 1. Dichiarazione della variabile per il risultato ---
	 ...
	 * Find by name
	 */
	public List<Object2DTO> findObject2ByString(String string) {
		// --- 1. Dichiarazione della variabile per il risultato ---
		List<Object2DTO> result = new ArrayList<Object2DTO>();
		// --- 2. Controlli preliminari sui dati in ingresso ---
		if ( string == null || string.equals("") )
		{
			//logger.warning("findObject2ByString(): string is invalid");
			return result;
		}
		// --- 3. Apertura della connessione ---
		Connection conn = Db2DAOFactory.createConnection();
