/*
	Questa classe è pensata come supporto alla persisitenza per rendere trasprente all'utente l'istanziamento di 
	connessioni di DB differenti.
*/
...
public class DataSource 
{
	...
	private final int usedDb;
	
	// nome del database
	private String dbName = "sit_stud"; //funziona solo con il DB di sistemi operativi!!!!
